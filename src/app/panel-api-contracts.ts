...
export * from "./panel-api/index.js";
 ...
 */
export type SynechProjectionChange = {
  readonly revision: number;
  readonly owners: readonly SynechProjectionOwner[];
