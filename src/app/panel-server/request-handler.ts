...
function createPanelRequestHandler(runtime: PanelHost): (request: IncomingMessage, response: ServerResponse) => void {
  return (request, response) => {
    ...
    requestJob = handlePanelRequest(runtime, runtime.managedSpaceFolderApplication, request, response).catch((error) => {
...
async function handlePanelRequest(
  runtime: PanelHost,
  managedSpaceFolderApplication: ManagedSpaceFolderApplication<import("../spaces/index.js").SpaceReferenceItem>,
  ...
  if (await handlePanelOrdinaryRoute({
    ordinaryAgentFeature: runtime.ordinaryAgentFeature,
    ordinaryTurnApplication: runtime.ordinaryTurnApplication,
  ...
  if (await handlePanelSpaceRoute({
    ...
    spaceReferenceContentApplication: runtime.spaceReferenceApplications.content,
    spaceReferenceLifecycleApplication: runtime.spaceReferenceApplications.lifecycle,
    flushSpaceKnowledgeSync: runtime.flushSpaceKnowledgeSync,
