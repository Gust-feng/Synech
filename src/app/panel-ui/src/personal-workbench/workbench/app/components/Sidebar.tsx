...
import { WorkspaceSidebarLoadingRows, WorkspaceSidebarRow } from './WorkspaceSidebarRow'
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div className="space-y-0.5">
          {workspaceLoadState?.loading === true && workspaces.length === 0 && <WorkspaceSidebarLoadingRows />}
