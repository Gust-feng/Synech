...
export const PRODUCT_DATA_FORMAT_ID = "synech/v1" as const;
...
export const PRODUCT_CONFIG_ENVIRONMENT_VARIABLE = "SYNECH_CONFIG_DIR" as const;
...
export const PRODUCT_RUNTIME_BIN_ENVIRONMENT_VARIABLE = "SYNECH_RUNTIME_BIN" as const;
